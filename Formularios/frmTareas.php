...
<main class="contenido">
  <div class="principal">
    <div class="containerMenuCalendario" id="containerMenuCalendario">
      ...
      <div id="buscar">
        <a href="frmCalendarioBuscar.php">Todas mis tareas</a>
      </div>
      <div  id="eliminar"> 
        <a href="">Eliminar</a>
      </div>
  ...
  <div class="container">
        ...
        <form action="http://localhost/Proyecto_final/academiapp/Controlador/procesarMovimientoTareas.php" method="POST">
            ...
            <div class="form-group">
                <label for="nombre">Materia donde se entrega:</label><br>
                <input type="text" id="NombreMateria" name="NombreMateria" placeholder="Nombre identico en la tabla Materias" required style="border-radius: 20px;">
            </div>

            <div class="form-group">
                <label for="fecha">Fecha de entrega:</label><br>
                <input type="date" id="FechaEntrega" name="FechaEntrega" required style="border-radius: 20px;">
            </div>
