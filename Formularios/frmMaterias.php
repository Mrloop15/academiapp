...
<main class="contenido">
  <div class="principal">
    <div class="containerMenuCalendario" id="containerMenuCalendario">
      <div id="crear" >
        <a href="http://localhost/Proyecto_final/Formularios/frmMaterias.php">Agregar</a>
      </div>
      <div id="buscar">
        <a href="#">Buscar</a>
      </div>
  ...
  <div class="container">
        ...
        <form action="procesar_registro_evento.php" method="POST">
            <div class="form-group">
                <label for="nombre">Id Materia:</label><br>
                <input type="text" id="idMateria" name="idMateria" required style="border-radius: 20px;">
            </div>

            <div class="form-group">
                <label for="nombre">Nombre de la clase:</label><br>
                <input type="text" id="nombreClase" name="nombreClase" required style="border-radius: 20px;">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="descripcionClase" name="descripcionclase" rows="4" cols="50" required style="border-radius: 20px;"></textarea>
            </div>

            <div class="form-group">
                <label for="organizador">Maestro:</label><br>
                <input type="text" id="maestro" name="maestro" required style="border-radius: 20px;">
            </div>
